                ...
                <div class="form-group-box">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <div class="form-group-items w-100 ms-2 me-2">
                            <div class="group-item">
                                ...
                                <input type="text" class="form-control" value="{{ $clientes->insc_estadual }}" name="insc_estadual">
                            </div>
                        </div>
                        <div class="form-group-items w-100">
                            <div class="group-item">
                                <label for="">Nome / Razão social;</label>
                                <input type="text" class="form-control" value="{{ $clientes->nome_razao_social }}" name="nome_razao_social">
                            </div>
                        </div>
                        <div class="form-group-items w-100 ms-2">
                            <div class="group-item">
                                <label for="">Nome Fantasia:</label>
                                <input type="text" class="form-control" value="{{ $clientes->nome_fantasia }}" name="nome_fantasia">
                            </div>
                        </div>
                    ...
                    <div class="form-group d-flex justify-content-between mt-4">
                        ...
                        <div class="form-group-items w-100 ms-2 me-2">
                            <div class="group-item">
                                <label for="">CEP:</label>
                                <input type="text" class="form-control" value="{{ $clientes->cep }}" name="cep">
                            </div>
                        </div>
                        <div class="form-group-items w-100">
                            <div class="group-item">
                        ...
                        <div class="form-group-items w-100 ms-2">
                            <div class="group-item">
                                ...
                                <input type="text" class="form-control" value="{{ $clientes->numero }}" name="numero">
                            </div>
                        </div>
                    ...
                    <div class="form-group d-flex justify-content-between mt-4">
                        <div class="form-group-items w-100">
                            <div class="group-item">
                                ...
                                <input type="text" class="form-control" value="{{ $clientes->bairro }}" name="bairro">
                            </div>
                        </div>
                        <div class="form-group-items w-100 ms-2 me-2">
                            <div class="group-item">
                                <label for="">Cidade:</label>
                                <input type="text" class="form-control" value="{{ $clientes->cidade }}" name="cidade">
                            </div>
                        </div>
                        <div class="form-group-items w-100">
                            <div class="group-item">
                                <label for="">UF:</label>
                                <input type="text" class="form-control" value="{{ $clientes->uf }}" name="uf">
                            </div>
                        </div>
                        <div class="form-group-items w-100 ms-2">
                            <div class="group-item">
                                <label for="">Ponto de Referência:</label>
                                <input type="text" class="form-control" value="{{ $clientes->ponto_referencia }}" name="ponto_referencia">
                            </div>
                        </div>

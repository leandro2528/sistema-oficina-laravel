...
<div class="container-fluid p-3">
    <div class="row">
        ...
        <div class="col-2">
            <a class="btn btn-outline-primary btn-sm" href="{{ route('fornecedors-create') }}">
                <span>
            ...
            <table class="table table-hover">
                ...
                @foreach($fornecedors as $fornecedor)
                    <tr>
                        ...
                        <td>{{ $fornecedor->ponto_referencia }}</td>
                        <td class="d-flex">
                            <a class="btn btn-outline-warning btn-sm" href="{{ route('fornecedors-edit', ['id'=>$fornecedor->id]) }}">

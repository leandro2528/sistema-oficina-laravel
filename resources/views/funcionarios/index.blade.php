...
<div class="container-fliud p-3">
    <div class="row">
        <div class="col-10">
            <h6>Funcionarios Cadastrados</h6>
        </div>
        <div class="col-2">
            <a class="btn btn-outline-primary btn-sm" href="{{ route('funcionarios-create') }}">
                <span>
            ...
            <table class="table table-hover">
                ...
                <tbody style="font-size: 10px;">
                    ...
                    <tr>
                        ...
                        <td>{{ $funcionario->data_nacscimento }}</td>
                        ...
                        <td class="d-flex">
                            <a class="btn btn-outline-warning btn-sm" href="{{ route('funcionarios-edit', ['id'=>$funcionario->id]) }}">
